...
export async function generateRecipes(
  ...
  const {
    ...
    cuisine = "",
    notes = "",
    dietType = "veg", // default to "veg"
  } = params;

  console.log("Function called, dietType:", dietType);
...
16) The user’s diet preference is: ${dietType}.
   ...
   - If "both", anything goes, no constraints on veg/non-veg.
...
`;
  ...
  // 3) Call the external API (OpenRouter or other)
